...
var Region = regionTemp.reduce(function(rv, value) {
    (rv[value["Continent_Name"]] = rv[value["Continent_Name"]] || {});
    rv[value["Continent_Name"]][value["Country_Name"]] = value["Two_Letter_Country_Code"];
    return rv;
}, {})  