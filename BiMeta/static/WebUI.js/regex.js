$('.kmer').on("input",function insertKmer(evt){
    ...
    if (!ok){
        ...
        document.querySelector("#startButton").className="submit_button bold submit_disable";
...
$('.kmer').after('<div class="col error-message">Please input a positive number !</div>')
...
$('.lofqmer').after('<div class="col error-message">Please input a positive number !</div>')
...
$('.sharereads').after('<div class="col error-message">Please input a positive number !</div>')
...
$('.maxcomp').after('<div class="col error-message">Please input a positive number !</div>')